...
/**
 * This is for PwnCord developers.
 * I decided to keep this separate from the main Devs object, as I respect their contributions to the community.
*/
export const PwnDevs = /* #__PURE__*/ Object.freeze({
    Proto: {
        name: "proto",
...
export const PwnDevsById = /* #__PURE__*/ (() =>
    Object.freeze(Object.fromEntries(
        Object.entries(PwnDevs)
            .filter(d => d[1].id !== 0n)
            .map(([_, v]) => [v.id, v] as const)
    ))
)() as Record<string, Dev>;
